...
function Set_vod(){
  ...
  useEffect(()=>{
    if(vodSetting){
      setContents(vodSetting.title);
      if(vodSetting.img !== null){
        setUpload(vodSetting.img);
      }
    }
  }, [vodSetting])
  ...
  if(vodSetting){
    return(
      <form id="vodSetting" data-whats="admin_vod" data-idfy="admin_setting">
          ...
          <div className="inner_con">
            <div className="input_con img_input">
              <label>
                ...
                <div className="upload_img">
                  {upload_logo_img == '' ? <img src="img/basic/notice/notice_base.jpg"></img> : upload_logo_img !== '' && vodSetting.img == '' ? <img src={upload_logo_img}></img> : <img src={"data:image;base64,"+upload_logo_img} alt="이미지 경로를 확인해주세요"></img>}
                </div>
              </label>
              {
            ...
            <div className="opa_con">
              <div className="opacity_con">
                <input type="color" name="bgcolor" className="clr_input" defaultValue={vodSetting.bgcolor}></input>
                <div className="range_con">
                  <input type="range" name="transparent" className="opacity_input" min={0} max={100} defaultValue={vodSetting.transparent} onChange={(e)=>{
                    let val = e.target.value;
                    $(".opa span").text(val+"%")
                  }}></input>
                  <p className="opa"><span>{vodSetting.transparent}%</span>배경색 투명도</p>
                </div>
              </div>
              <div className="ex_con">
                <p className="row_desc">결과예시)</p>
          ...
          <div className="title_con">
            ...
            <div className="check_con">
              <label>
                ...
                <input className="check_menu input_check" name="title_show" type="checkbox" value='Y' defaultChecked={vodSetting.title_show == "Y" ? true : false}></input>
